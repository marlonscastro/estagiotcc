...
ALTER TABLE UNI_UNIDADE_OPERACIONAL ADD FOREIGN KEY(ORG_ID) REFERENCES ORG_ORGAO (ORG_ID);
ALTER TABLE TEL_TELEFONE ADD FOREIGN KEY(ENV_ID) REFERENCES ENV_ENVOLVIDO (ENV_ID);
